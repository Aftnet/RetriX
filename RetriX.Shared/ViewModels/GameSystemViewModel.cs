...
namespace RetriX.Shared.ViewModels
{
    public class GameSystemViewModel
    {
        ...
        public static GameSystemViewModel Make32X(ICore core, IFileSystem fileSystem) => new GameSystemViewModel(core, fileSystem, Strings.SystemName32X, Strings.ManufacturerNameSega, "\uf124", false, new HashSet<string> { ".32x", ".bin" });
